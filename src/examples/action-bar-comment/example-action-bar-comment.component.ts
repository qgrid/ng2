...
@Component({
	selector: 'example-action-bar-comment',
	templateUrl: 'example-action-bar-comment.component.html',
	styleUrls: ['example-action-bar-comment.component.scss'],
	providers: [DataService]
})
export class ExampleActionBarCommentComponent {
