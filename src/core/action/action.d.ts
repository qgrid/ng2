...
/**
 * Use this class to connect qgrid [command](/doc/api/command.html) and UI. Usually action represents a button, but not nessesary, custom template can be [used to](/doc/features/action-bar).
